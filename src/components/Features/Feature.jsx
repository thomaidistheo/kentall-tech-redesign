...
function Feature() {
  return (
    <div className="feature">
        ...
        <p className="feature-title">Fleet Management</p>
        <span className="seperator"></span>
        <p className="feature-desc">Manage your fleet from one account, or create sub user accounts for clients and personnel with ease</p>
    </div>
  )
}
