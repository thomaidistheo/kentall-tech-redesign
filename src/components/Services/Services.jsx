  ...
  return (
    <div className="service-cards-cont">
      <div className='service-card'>
          <div className="service-card__content">
              <div className="card-text">
                  <h2 className="card-text__title">Our Products</h2>
              ...
              <div className="card-img">
                <Image src={imageOne} alt="Kentall tracking products" />
              </div>
          </div>
      </div>
      ...
      <div className='service-card'>
          <div className="service-card__content">
              <div className="card-text">
                  <h2 className="card-text__title">Software <span className="card-text__subtitle">[Tracking Platform]</span></h2>
                  <div className="card-text__desc">
                    ...
                    <br/><br/>
                    With our Platform you can view a trip history of up to 6 months, create zones and get reports of entering/leaving those zones, set up email alerts for specific events such as engine on/off or entering/leaving zones and more. <Link href="/guides" className='link-text'>Here you can find a guide</Link> for all the features our platform has to offer.
                    <br/><br/>
                    If you’re a business that manages fleets of boats, learn more about how we provide tailored reports for the Greek Tax laws <Link href="/product-boat" className='link-text'>here.</Link>
                  </div>
              </div>
              <div className="card-img">
                <Image src={imageTwo} alt="Software solutions illustration"/>
              </div>
          </div>
      </div>
      ...
      <div className='service-card'>
          <div className="service-card__content">
              <div className="card-text">
                  <h2 className="card-text__title">Hardware Devices</h2>
                  <div className="card-text__desc">
                    ...
                    <br/><br/>
                    Find out more about each device’s specifications on our <Link href="/" className='link-text'>Products Page</Link>.
                  </div>
              </div>
              <div className="card-img">
                <Image src={imageThree} alt="Hardware tracking devices"/>
              </div>
          </div>
      </div>
